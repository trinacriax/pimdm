    ...
    pimdm::PIMHeader::HelloMessage &helloMessage = msgIn.GetHelloMessage();
      {
        ...
        struct pimdm::PIMHeader::HelloMessage::HelloEntry::HoldTime tmp1 =
          { Time("1401s") };
        ...
        struct pimdm::PIMHeader::HelloMessage::HelloEntry::LanPruneDelay tmp2 =
          { 1, Time("10ms"), Time("20ms") };
        ...
        struct pimdm::PIMHeader::HelloMessage::HelloEntry::HoldTime tmp3 =
          { Time("2802s") };
        ...
        struct pimdm::PIMHeader::HelloMessage::HelloEntry::GenerationID tmp4 =
          { 1234567890 };
        ...
        struct pimdm::PIMHeader::HelloMessage::HelloEntry::StateRefreshCapable tmp5 =
          { 9, 18, 9999 };
...
//	helloEntry1
        ...
        std::cout << "\n\tType " << helloEntry3.m_optionType << " Length " << helloEntry3.m_optionLength << " Value ["
            << helloEntry3.m_optionValue.holdTime.s_holdTime << "]\n";
        ...
        std::cout << "\n\tType " << helloEntry4.m_optionType << " Length " << helloEntry4.m_optionLength << " Value ["
            << helloEntry4.m_optionValue.generationID.s_generatioID << "]\n";
        ...
        std::cout << "\n\tType " << helloEntry5.m_optionType << " Length " << helloEntry5.m_optionLength << " Value ["
            << (uint16_t) helloEntry5.m_optionValue.stateRefreshCapable.s_version << ","
        ...
        NS_TEST_ASSERT_MSG_EQ(helloEntry5.m_optionType, pimdm::PIMHeader::HelloMessage::StateRefreshCapable,
            "Option Type");
  ...
  PimDmJoinPruneTestCase::DoRun (void)
  {
    ...
    pimdm::PIMHeader::JoinPruneMessage &messageIn = msgIn.GetJoinPruneMessage();
      {
        pimdm::PIMHeader::EncodedUnicast eu =
          { 5, 10, Ipv4Address("192.168.1.1") };
        ...
        pimdm::PIMHeader::MulticastGroupEntry m_entry1;
          {
            pimdm::PIMHeader::EncodedGroup eg =
              { (uint8_t) 7, (uint8_t) 14, (uint8_t) 0, (uint8_t) 0, (uint8_t) 1, (uint8_t) 4, Ipv4Address(
                  "192.168.10.10") };
            m_entry1.m_multicastGroupAddr = eg;
            m_entry1.m_numberJoinedSources = 2;
            m_entry1.m_numberPrunedSources = 2;
              {
                pimdm::PIMHeader::EncodedSource j1 =
                  { 8, 16, 0, 1, 0, 0, 4, Ipv4Address("192.168.10.20") };
                m_entry1.m_joinedSourceAddrs.push_back(j1);
                pimdm::PIMHeader::EncodedSource j2 =
                  { 9, 18, 0, 0, 1, 0, 6, Ipv4Address("192.168.10.22") };
                m_entry1.m_joinedSourceAddrs.push_back(j2);
              }
              {
                pimdm::PIMHeader::EncodedSource p1 =
                  { 3, 6, 0, 1, 0, 0, 8, Ipv4Address("192.168.10.40") };
                m_entry1.m_prunedSourceAddrs.push_back(p1);
                pimdm::PIMHeader::EncodedSource p2 =
                  { 4, 8, 0, 0, 1, 0, 7, Ipv4Address("192.168.10.42") };
        ...
        jpg.Print(std::cout);
          {
            ...
            NS_TEST_ASSERT_MSG_EQ(jpg.m_upstreamNeighborAddr.m_unicastAddress, Ipv4Address("192.168.1.1"),
                "Unicast Address");
          }
  ...
  PimDmAssertTestCase::DoRun (void)
  {
    ...
    pimdm::PIMHeader::AssertMessage &assertMessage = msgIn.GetAssertMessage();
      {
        pimdm::PIMHeader::EncodedGroup eg =
          { 6, 5, 1, 0, 0, 4, Ipv4Address("192.168.6.3") };
        assertMessage.m_multicastGroupAddr = eg;
        pimdm::PIMHeader::EncodedUnicast eu =
          { 7, 8, Ipv4Address("192.168.6.6") };
      ...
      }
      {
        ...
        NS_TEST_ASSERT_MSG_EQ(assertOut.m_multicastGroupAddr.m_groupAddress, Ipv4Address("192.168.6.3"),
            "Group Address");
    ...
    pimdm::PIMHeader::StateRefreshMessage &stateIn = msgIn.GetStateRefreshMessage();
      {
        ...
        pimdm::PIMHeader::EncodedUnicast ou =
          { 20, 98, Ipv4Address("192.169.2.6") };
      ...
      }
      {
        ...
        NS_TEST_ASSERT_MSG_EQ(stateOut.m_multicastGroupAddr.m_groupAddress, Ipv4Address("192.168.6.3"),
            "Group Address");
        ...
        NS_TEST_ASSERT_MSG_EQ(stateOut.m_originatorAddr.m_unicastAddress, Ipv4Address("192.169.2.6"),
            "Unicast Address");
