...
//					AddEntry(Ipv4Address::GetAny(), group, Ipv4Address::GetAny(), i);
...
////					for(int j = 0; j < m_ipv4->GetNInterfaces (); j++){
//					int j = i;
...
////					socket->BindToNetDevice (m_ipv4->GetNetDevice (i));//comment out otherwise 0 will not receive data
