...
void
MulticastRoutingProtocol::RPF_primeChanges(SourceGroupPair &sgp, Ipv4Address oldgateway)
{
	...
	sgState = FindSourceGroupState(interface, newgateway, sgp, true); // find new RPF pair...
